...
- 全量汉化全部 TypeScript 源码中所有面向用户的英文文本，覆盖 130+ 文件
- 汉化全部文档（docs/）、README、示例文件（examples/）
- 全面汉化设置界面所有选项标签和描述、会话信息面板、状态提示消息、交互提示文本等
- 中文化全部 UI 文本：快捷键描述、斜杠命令描述、CLI 帮助、工具描述/参数描述、系统提示词注释、错误消息等
- 汉化 packages/agent 和 packages/ai 核心代码中的 UI 文本
