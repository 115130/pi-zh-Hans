...
import { getBundledInteractiveAssetPath, isBunBinary } from "../../../config.ts";
...
function loadImageBase64(): string | undefined {
	...
	try {
		if (isBunBinary && (globalThis as any).__EMBEDDED_LOGO_BASE64__) {
			cachedImageBase64 = (globalThis as any).__EMBEDDED_LOGO_BASE64__ as string;
		} else {
