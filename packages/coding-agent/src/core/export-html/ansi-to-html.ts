 ...
 * ANSI转义码到HTML的转换器。
 *
 * 将终端ANSI颜色/样式码转换为带内联样式的HTML。
 * 支持：
 * - 标准前景色（30-37）和亮色变体（90-97）
 * - 标准背景色（40-47）和亮色变体（100-107）
 * - 256色调色板（38;5;N和48;5;N）
 * - RGB真彩色（38;2;R;G;B和48;2;R;G;B）
...
// 匹配ANSI转义序列：ESC[后跟参数并以'm'结尾
const ANSI_REGEX = /\x1b\[([\d;]*)m/g;

/**
 * 将ANSI转义文本转换为带内联样式的HTML。
 */
