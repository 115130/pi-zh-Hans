	...
	"poe": {
		...
		"gemma-4-26b-a4b-el": {
			...
			cost: {
				input: 0.0505,
				output: 0.2929,
				cacheRead: 0.025300000000000003,
				cacheWrite: 0,
			},
			contextWindow: 4096,
			maxTokens: 4096,
		...
		"glm-4.6v": {
			...
			cost: {
				input: 0.303,
				output: 0.9091,
				cacheRead: 0.055600000000000004,
				cacheWrite: 0,
			},
			contextWindow: 131000,
			maxTokens: 131000,
		...
		"o1-pro": {
			...
			input: ["text", "image"],
			cost: {
				input: 136.36360000000002,
				output: 545.4544999999999,
				cacheRead: 0,
				cacheWrite: 0,
			},
			contextWindow: 200000,
